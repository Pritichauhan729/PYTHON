...
urlpatterns = [
    ...
    path('society-change-password/', views.societymember_change_password, name="societymember-change-password"),
    path('society-profile/', views.societymember_profile, name="societymember-profile" ),
